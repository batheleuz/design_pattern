...
function page()
{
                ...
                <?php foreach (ReportingCRUD::getReportings($_SESSION['service']['nom']) as $reporting): ?>
                    <tr class="w3-large w3-text-dark-grey" id="<?= $reporting['id']; ?>">
                        ...
                        <td class="w3-center">
                            ...
                            <?php if ($_SESSION['service']['id_admin'] == $_SESSION['user']['id'] || $_SESSION['user']['login'] == $reporting['user']): ?>
    ...
    <div class="w3-card w3-padding w3-white w3-animate-right" id="content" style="display:none;">
        ...
        <div class="w3-container w3-padding w3-border">
            ...
            <div class="w3-row-padding w3-border w3-light-gray"><h4 class="w3-text-dark-gray"><i
                        class="fa fa-wrench"></i> Configurations du projet </h4></div>
            <div class="w3-row-padding">
            ...
            <div style="padding: 0 30px; ">
                <hr class="w3-border w3-border-light w3-margin-0">
            </div>
            <div class="w3-row-padding">
            ...
            <ul class="w3-padding-0 w3-border w3-ul w3-hoverable" id="list_report"
...
CodeCompressor::importer(PATH . '/vue/app/reportingFilesScript.php', "js");
