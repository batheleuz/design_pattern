...
<h3 class="w3-padding-0 w3-text-grey"><i class="fa fa-users"></i>
    UTILISATEURS DU SERVICE <?= $_SESSION['service']['nom']; ?>
...
<div class="w3-container w3-border w3-white w3-padding-0 ">
    <div class="w3-row">
        <div class="w3-quarter w3-padding-large">
            <h4 class="w3-center">
                Service: <?= $_SESSION['service']['direction'] . "/" . $_SESSION['service']['nom'] ?> </h4>
            <hr style='border-top:solid 1px #ccc;'>
            <div class="w3-col m12 w3-margin-bottom ">
                <a class="   w3-text-teal w3-hover-text-blue  " style="cursor:pointer;"
                   onclick="document.getElementById('modal_add_user').style.display='block'">
            ...
            <table class="w3-table-all w3-hoverable ">
                ...
                <?php foreach (Database::getDb()->all('user', "service", $_SESSION['service']['id']) as $user): ?>
                    <tr id="<?= $user['id']; ?>" style="cursor: pointer;">
                        <td><img src="<?= ASSETS . "/image/avatar/" . $user['icon']; ?>" class="w3-circle"
        ...
        <div class="w3-modal-content w3-card-8" style="width:600px;">
            ...
            <form action="" id="add_user">
                    ...
                    <div class="w3-section">
                        <div class="w3-row">
                            ...
                            <div class="w3-threequarter w3-padding-bottom">
                                ...
                                <ol id="selectable">
                                    <?php for ($i = 1; $i <= 6; $i++): ?>
                                        <li style="width:50px;height:50px;" class="w3-col ui-state-default w3-border"
                                            value="<?= 'avatar' . $i . '.png'; ?>">
                                            <img src="<?= ASSETS . 'image/avatar/avatar' . $i . '.png' ?>"
                                                 class="w3-circle" style="height:100%;">
                                        </li>
                                    <?php endfor; ?>
                                </ol>
                            </div>
                        ...
                        <div class="w3-row">
                            ...
                            <div class="w3-threequarter"><input onkeyup="generateLogin()"
                                                                class="w3-input w3-border w3-margin-bottom" type="text"
                                                                placeholder="Entrer le nom" name="nom" required></div>
                        </div>
                        <div class="w3-row">
                            <div class="w3-quarter"><p><label><b>PRENOM</b></label></div>
                            <div class="w3-threequarter"><input onkeyup="generateLogin()"
                                                                class="w3-input w3-border w3-margin-bottom" type="text"
                                                                placeholder="Entrer le prenom" name="prenom" required>
                            </div>
                        </div>
                        <div class="w3-row">
                            <div class="w3-quarter"><p><label><b>EMAIL</b></label></div>
                            <div class="w3-threequarter"><input class="w3-input w3-border w3-margin-bottom" type="email"
                                                                placeholder="Entrer l'Email" name="email" required>
                            </div>
                        </div>
                        <div class="w3-row">
                            <div class="w3-quarter"><p><label><b>LOGIN</b></label></div>
                            <div class="w3-threequarter"><input class="w3-input w3-border w3-margin-bottom" type="text"
                                                                placeholder="Login" name="login" required></div>
                        </div>
                        <div class="w3-row">
                ...
                <footer class="w3-container w3-light-gray  w3-padding-bottom w3-padding-top ">
                    <div class="w3-right">
                        <a class="w3-light-gray w3-padding-right w3-text-teal" id="chargement" style="display:none;"> <i
                                class="fa fa-spinner fa-pulse"></i> </a>
