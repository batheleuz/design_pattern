...
<style></style>
<body>
<img class="w3-image w3-greyscale-max" src="<?= ASSETS ?>image/12.jpg" style=" width:100%;height:100%;">
<div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
    <div class="w3-black w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Connexion</h1>
        <hr class="w3-opacity">
        <form action="" method="POST">
            <div class="w3-padding "><input type="text" class="w3-input" id="login" name="login"
                                            placeholder="Nom d'utilisateur" required autofocus></div>
            <div class="w3-padding "><input type="password" class="w3-input" id="pwd" name="pwd"
                                            placeholder="mot de passe" required></div>
            <div class="w3-padding ">
                <h5>
                    <button type="submit"
                            class="w3-btn w3-deep-orange w3-border w3-border-white w3-hover-white w3-hover-border-deep-orange ">
                        Connexion
                    </button>
                    <a class="w3-margin-top w3-black " id="loading" style="display:none;"><i
                            class='fa fa-spinner fa-pulse'></i> Patientez ...</h5>
                </a>
