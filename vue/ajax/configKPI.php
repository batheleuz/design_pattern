        ...
        <div class="w3-twothird w3-card">
            <div class="w3-row-padding ">
                ...
                <div class="w3-col" style="width: 100px">
                    <br>
                    <button
                        class="w3-btn w3-teal w3-hover-white  w3-large w3-round-large w3-border w3-border-grey w3-hover-border-teal kpi_config "
        ...
        <div class=" w3-card w3-margin-bottom">
            <div class="w3-container w3-padding">
                ...
                <div class="w3-row-padding">
                    ...
                    <div class="w3-half w3-padding ">
                        <input type="number" min=1 name="" placeholder="Valeur de n" id="delai"
                               class="w3-input w3-border w3-paddin-0" style="padding:4px;">
                    </div>
                </div>
                <div class="w3-row-padding">
...
CodeCompressor::importer(PATH . "/vue/ajax/configKPIScript.php", "js");
