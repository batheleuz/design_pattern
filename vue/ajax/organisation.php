...
function page()
{
    ...
    <div class="w3-row">
        <div class="w3-col m3 ">
            ...
            <div class="w3-container w3-border w3-pale-green w3-padding " style="height:550px;">
                <table class="w3-table w3-large " id="list_cat">
                    <tr class="w3-hover-light-green w3-border w3-light-green cat">
                        <th>Toute <i class="fa fa-arrow-circle-o-right w3-right"></i></th>
                    </tr>
                    <tr class="w3-hover-light-green w3-border cat" data-cat="direction">
                        <th>Direction <i class="fa fa-arrow-circle-o-right w3-right"></i></th>
                    </tr>
                    <tr class="w3-hover-light-green w3-border cat" data-cat="sous_traitant">
                        <th>Sous traitant <i class="fa fa-arrow-circle-o-right w3-right"></i></th>
                    </tr>
                    <tr class="w3-hover-light-green w3-border cat" data-cat="autre">
                        <th> Autre <i class="fa fa-arrow-circle-o-right w3-right"></i></th>
                    </tr>
                </table>
                ...
                <div class="w3-container w3-padding">
                    ...
                    <div class="w3-col m12 w3-margin-bottom "><a class="   w3-text-teal w3-hover-text-blue  "
                    ...
                    <div class="w3-col m12 "><a class="w3-margin-top w3-text-teal w3-hover-text-blue  "
                                                style="cursor:pointer;"
        ...
        <div class="w3-col m4 ">
            ...
            <div class="w3-container w3-border w3-padding w3-light-grey"
                 style="height:550px;overflow:wrap;overflow-y:scroll">
    ...
    <div id="modal_add_gi" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-round w3-card-8 " style="width:500px;">
            <div class="w3-container w3-border">
                <span onclick="document.getElementById('modal_add_gi').style.display='none'"
                      class="w3-closebtn">&times;</span>
                <div class="w3container w3-border w3-padding w3-margin"><h4 class="w3-center">Ajouter un Groupe
                        d'intervention</h4></div>
                ...
                <form class="w3-container w3-padding" id="form_add_gi">
                    ...
                    <button class="w3-btn w3-border w3-hover-border-teal w3-hover-white w3-teal w3-margin-top w3-right">
    ...
    <div id="modal_add_ui" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-round w3-card-8" style="width:500px;">
            <div class="w3-container w3-border">
                <span onclick="document.getElementById('modal_add_ui').style.display='none'"
                      class="w3-closebtn">&times;</span>
                <div class="w3container w3-border w3-padding w3-margin"><h4 class="w3-center">Ajouter une Unité
                        d'Intervention </h4></div>
                ...
                <form class="w3-container w3-padding" id="form_add_ui">
                    ...
                    <select data-placeholder="Groupes ... " id="multi_grpe" name='groupes[]' multiple
    ...
    <div id="modal_add_existant_ui" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-round w3-card-8" style="width:400px;">
            <div class="w3-container w3-border">
                <span onclick="document.getElementById('modal_add_existant_ui').style.display='none'"
                      class="w3-closebtn">&times;</span>
                <div class="w3container w3-border w3-padding w3-margin"><h5 class="w3-center"> Gerer les ui </h5>
                </div>
                <div class="w3container w3-padding ">
                    <input type="text" id="search_ui" class="w3-input w3-margin-right w3-border w3-light-grey"
                           onkeyup="filterListUI()" placeholder="Rechercher ... ">
                </div>
...
CodeCompressor::importer(PATH . "/vue/ajax/organisationScript.php", "js");
